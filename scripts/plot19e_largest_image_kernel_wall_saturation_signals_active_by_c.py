...
OUT_PNG = RESULTS_DIR / "plot19e_largest_image_kernel_wall_saturation_signals_active_by_c.png"
OUT_PDF = RESULTS_DIR / "plot19e_largest_image_kernel_wall_saturation_signals_active_by_c.pdf"
