...
DEFAULT_OUTPUT_STEM = RESULTS_DIR / "plot17b_kernel_time_breakdown_with_disk"
DEFAULT_SUMMARY_CSV = DERIVED_DIR / "plot17b_kernel_time_breakdown_with_disk_summary.csv"
